...
beta_small_bayes <- data.est$cases + alpha_small + beta_small

alpha_big_bayes <- data.est$deaths + alpha_big
beta_big_bayes <- data.est$cases + alpha_big + beta_big
...
bayes_estimate1 = (data.est$deaths + alpha_small)/
  (data.est$cases+ alpha_small + beta_small)
bayes_estimate2 = (data.est$deaths + alpha_big)/
  (data.est$cases+ alpha_big + beta_big)
